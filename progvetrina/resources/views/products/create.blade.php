    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card shadow p-4">
          <h3 class="text-center mb-4 fw-bold text-dark">Aggiungi un nuovo prodotto</h3>
          ...
          <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="name" class="form-label fw-bold">Nome dell'articolo</label>
              <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Es. Margherita, Diavola..." >
            ...
            <div class="mb-3">
              ...
              <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="Es. Pomodoro, mozzarella, basilico fresco...">{{ old('description') }}</textarea>
            ...
            <div class="mb-3">
              <label for="image" class="form-label fw-bold">Immagine dell'articolo</label>
            ...
            <div class="d-flex gap-2">
              <button type="submit" class="btn btn-dark w-100 py-2 fw-bold">Inserisci nel Menu</button>
